	    ...
	    return (
	      React.DOM.nav({className: "navbar"}, 
	        ...
	        React.DOM.ul({className: "nav navbar-nav"}, 
	          ...
	          React.DOM.li({className: this._checkUri('trongthaonh')}, 
	            Link({ to: '/trongthaonh' }, 'Trong Thao Page')
	          )
	        )
	      )
	    );
	          ...
	          React.DOM.div({className: "container"}, 
	            ...
	            React.DOM.div({className: "row bottom"}, 
	              ...
	              React.DOM.div({className: "one-third column"}, 
	                ...
	                React.DOM.h4(null, "Honors"), 
	                React.DOM.ul(null, 
	                  React.DOM.li(null, "1st place in the contest \"MyContest\"")
	                )
	              )
	            )
	          )
